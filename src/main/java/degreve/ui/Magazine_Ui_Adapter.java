 ...
 */
public class Magazine_Ui_Adapter extends ArrayAdapter<Magazine> {
    private Context context;
    private int tuile_layout;
    private List<Magazine> list;

    public Magazine_Ui_Adapter(Context context, int resource, List<Magazine> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvName = (TextView) tuile.findViewById(R.id.lvGetAll_nameMag);
